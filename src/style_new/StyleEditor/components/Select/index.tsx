...
interface SelectProps {
  ...
  options: Array<{ value: any; label: string | number; suffix?: string | number; type?: 'action' | 'divider'; checked?: boolean; icon?: ReactNode; iconSize?: 'sm' | 'md'; disabled?: boolean; style?: CSSProperties; tip?: string }>;
  multiple?: boolean;
  /** 是否展示下拉的icon */
  showIcon?: boolean;
