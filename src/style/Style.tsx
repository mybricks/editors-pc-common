...
function getStyle(element) {
  ...
  const value = {
    ...
    borderRadius: `${computedStyle.borderTopLeftRadius} ${computedStyle.borderTopRightRadius} ${computedStyle.borderBottomRightRadius} ${computedStyle.borderBottomLeftRadius}`,
    borderStyle: `${computedStyle.borderTopStyle} ${computedStyle.borderRightStyle} ${computedStyle.borderBottomStyle} ${computedStyle.borderLeftStyle}`,
    borderColor: `${computedStyle.borderTopColor.replace(/\s/g, "")} ${computedStyle.borderRightColor.replace(/\s/g, "")} ${computedStyle.borderBottomColor.replace(/\s/g, "")} ${computedStyle.borderLeftColor.replace(/\s/g, "")}`,

    // bgcolor
    background: computedStyle.background, // 'url() center top / 100% 100% no-repeat, rgba(255,255,255,1)'

    // shadow
    boxShadow: computedStyle.boxShadow === 'none' ? '0px 0px 0px 0px #ffffff' : computedStyle.boxShadow
  }
