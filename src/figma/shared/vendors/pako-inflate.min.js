/**
 * pako 2.1.0 inflate 侧（inflate / inflateRaw / ungzip）— 仅用于 Figma 剪贴板解压
 * 来源: https://github.com/nodeca/pako — dist/pako_inflate.min.js — (MIT AND Zlib)
 * 与 vendors/pako.js（deflate 精简包）互补；内联避免 npm 依赖 pako。
 */
